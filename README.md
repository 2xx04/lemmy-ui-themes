...
^from https://github.com/LemmyNet/lemmy-docs/blob/main/src/en/administration/theming.md^
...
You can use [https://add0n.com/stylus.html](Stylus) to customize your webpage. You can sometimes get away with a {theme-name}.diff.css if it was based on another theme and you used that as a canvas, otherwise use the normal {theme-name}.css.
